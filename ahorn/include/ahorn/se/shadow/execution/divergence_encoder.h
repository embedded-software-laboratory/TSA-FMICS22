#ifndef AHORN_SHADOW_DIVERGENCE_ENCODER_H
#define AHORN_SHADOW_DIVERGENCE_ENCODER_H
...
namespace se::shadow {
    class DivergenceEncoder : private ir::ExpressionVisitor {
    private:
    ...
    private:
        static const std::string SYMBOLIC_SHADOW_VARIABLE_NAME_PREFIX;

    public:
        // XXX default constructor disabled
        DivergenceEncoder() = delete;
        // XXX copy constructor disabled
        DivergenceEncoder(const DivergenceEncoder &other) = delete;
        // XXX copy assignment disabled
        DivergenceEncoder &operator=(const DivergenceEncoder &) = delete;

        explicit DivergenceEncoder(Solver &solver);
