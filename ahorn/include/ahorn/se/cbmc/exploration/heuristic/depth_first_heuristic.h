#ifndef AHORN_CBMC_DEPTH_FIRST_HEURISTIC_H
#define AHORN_CBMC_DEPTH_FIRST_HEURISTIC_H
            ...
            if (context_1->getCycle() > context_2->getCycle()) {
                ...
                if (context_1->getCallStackDepth() > context_2->getCallStackDepth()) {
                    ...
                    if (vertex_1.getLabel() > vertex_2.getLabel()) {
                        ...
                        // XXX cbmc merges at all join points hence explorer should never have two contexts reaching
                        // XXX the same vertex/label
...
#endif//AHORN_CBMC_DEPTH_FIRST_HEURISTIC_H
